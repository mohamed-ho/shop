...
import 'package:shop/features/home/presentation/widgets/all_categories_tab_bar.dart';
      ...
      children: [
        Container(
          ...
          child: ListView(scrollDirection: Axis.horizontal, children: [
            ...widget.category.map((e) => CustomTabBar(
          ...
          ...widget.category.sublist(1).map(
                (e) => BlocProvider(
                  ...
                  create: (context) => ls<ProductCubit>()
                    ..getProductInCategory(categoryId: e.id),
